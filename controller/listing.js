...
module.exports.createListing = async (req, res, next) => {
    ...
    // safety check to prevent server crash if image upload fails
    console.log("REQ BODY:", req.body);
    console.log("FILE:", req.file);

    if (!req.file) {
        req.flash("error", "Image upload failed. Please upload a valid image.");
        return res.redirect("/listings/new"); //  already correct
    }
